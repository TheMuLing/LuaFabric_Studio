...
/**
 * Compose 打包基底入口（compose-apk launcher）：跳转精简 LuaActivity，
 * 保留 update.lua / unApk 解包流程。与 view 版 SplashWelcome 同构（view 版跳 com.androlua.Main）。
 */
class SplashWelcome : ComponentActivity() {
    ...
    private fun startMainActivity() {
        Intent(this@SplashWelcome, LuaActivity::class.java).apply {
            if (isVersionChanged) {
